...
var e=this,o=(this._o,e._g),i=1*t.position||0,a=t.type;
this.jsapiLog("jsapi_operateBackgroundAudio;param:"+JSON.stringify(t||{})),S.invoke("operateBackgroundAudio",{
operationType:a,
currentTime:i
},function(e){
!!b.debug&&console.log("operateBackgroundAudio "+a+",position:"+i+", log:"+JSON.stringify(e||{})),
-1===e.err_msg.indexOf("ok")&&("function"==typeof t.onError&&t.onError(e),"seek"===a?(o.stateChangeCallback.seeking=null,
o.stateChangeCallback.seeked=null):o.stateChangeCallback[a]=null);
...
!!b.debug&&console.log("seeked to play"),s&&(clearTimeout(s),s=null),e();
