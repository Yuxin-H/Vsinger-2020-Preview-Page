...
function T(e){
try{
for(var c=window.pageYOffset||document.documentElement.scrollTop,m=0;m<W.length;m+=K){
var g=W[m];
if(!(g.offsetTop>c+x.getInnerHeight()+100)){
var u=w.attr(g,"data-cpsstatus");
if("hide"==u){
g.setAttribute("data-cpsstatus","loading");
for(var f=""+m,y=1,v=m+1;v<W.length&&m+K>v;v++)f=f+"%2c"+v,y++;
...
"list"==H?W[V].innerHTML=n.tmpl(s,F,!1):"banner"==H?W[V].innerHTML=n.tmpl(r,F,!1):"card"==H&&(W[V].innerHTML=n.tmpl(a,F,!1));
}
}catch(U){
console.log(U);
}
...
}),"1"===window.localStorage.getItem(t)&&E.report110809(30)),e)for(var d=document.getElementsByClassName("js_pay_qrcode"),p="/mp/paysubqrcode?action=get_article_qrcode&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"#wechat_redirect",m=0,w=d.length;w>m;m++)d[m].src=p;
...
if(E.report110809(38),window.payProductId!==i.productId)return void E.report110809(44);
var a=[o.getElementsByClassName("js_pay_fee")[0],n.getElementsByClassName("js_pay_fee")[0]];
a.forEach(function(e){
var t="CNY"!==i.currencyCode?i.currencySymbol:"￥";
e.innerHTML=t+i.price.toFixed(2),e.parentNode.dataset.ready=1;
}),window.oriProductFee?("CNY"!==i.currencyCode&&E.report110809(40),E.reportOverseaPay(i.currencyCode,100*i.price.toFixed(2),1,r,i.countryCode,0,i.err_msg+(i.err_desc?"__"+i.err_desc:""))):(window.IAPProductInfo=i,
window.IAPProductInfo.invokeTime=r);
}else E.report110809(39),E.reportOverseaPay("",0,1,0,"",1,i.err_msg+(i.err_desc?"__"+i.err_desc:""));
}
});
...
if(!e&&1*n.dataset.ready===0)return!i&&z.show("生成订单中"),new Date-f>6e4?(z.hide(),
...
var r=function(){
var e="js_pay_qrcode_wrap",t=n.nextElementSibling;
...
_.isAndroid&&"1"===window.localStorage.getItem(t)&&E.report110809(31),E.report110809ForDevice(34);
var e=function(){
...
u=!1,E.report110809(e.err_msg.indexOf("ok")>-1?19:20),window.localStorage&&window.localStorage.setItem&&window.localStorage.setItem(t,"1"),
...
E.reportPay(o,1,t.order_id),e()):i.err_msg.indexOf("cancel")>-1?(u=!1,E.report110809(28),
E.reportPay(o,2,t.order_id),console.log("pay cancel")):i.err_msg.indexOf("fail")>-1?(u=!1,
E.report110809(16),E.reportPay(o,3,t.order_id,i.err_msg,i.err_code,i.err_domain),
...
console.log("directPay res: ",i,n),1===i?(E.report110809(17),E.reportPay(o,1,t.order_id,n,i),
e()):-1===i&&/:cancel$/.test(n)?(u=!1,E.report110809(29),E.reportPay(o,2,t.order_id,n,i),
console.log("pay cancel")):(u=!1,E.report110809(18),E.reportPay(o,3,t.order_id,n,i),
...
(M||navigator.userAgent.indexOf("Br_trunk")>-1)&&_.isIOS&&(s||d)&&!p?(console.info("[HEVC代理] 当前版本可以启用HEVC代理"),
y.invoke("imageProxyInit",{},function(t){
t.err_msg.indexOf(":ok")>-1?(L=t.serverUrl,window.__addIdKeyReport("28307",117)):t.err_msg.indexOf(":fail")>-1&&window.__addIdKeyReport("28307",118),
e();
})):e();
},pt=function(e){
...
is_https_res||D?a=a.http2https():("http:"==location.protocol||-1!=navigator.userAgent.indexOf("MicroMessenger"))&&(a=a.https2http())),
setTimeout(function(){
r.onload=function(){
...
window.__addIdKeyReport("28307",84)),o=et.addParam(o,"wxfrom","5",!0),is_https_res||D?(o=o.http2https(),
...
return L&&(v||b)&&(window.__addIdKeyReport("28307",106),o=et.addParam(o,"tp","wxpic",!0),
o=L+"hevc?url="+encodeURIComponent(o)+"&type="+o.getOriginImgType()),"anonymous"==e.crossOrigin&&(o=et.addParam(o,"wx_co","1",!0)),
...
mid:"mmbizwap:imgMonitor",
view:"wap_appmsg"
}),L&&e.indexOf(L)>-1&&window.__addIdKeyReport("28307",108),d>o){
...
e.indexOf(!1)&&(e=e.http2https())),L&&e.indexOf(L)>-1){
...
1>=r&&window.__addIdKeyReport("28307",87+1*r)),L&&e.indexOf(L)>-1&&window.__addIdKeyReport("28307",107),
...
var ht=e("question_answer/appmsg.js");
ht.renderQaCard&&ht.renderQaCard({
mid:window.mid,
idx:window.idx,
...
}(),m("[Appmsg] href:"+location.href+"^^^ ua:"+window.navigator.userAgent),window.addEventListener?window.addEventListener("load",N,!1):window.attachEvent&&window.attachEvent("onload",N),
...
var vt=Math.random();
if(2e-4>vt)try{
for(var bt=document.getElementsByTagName("img"),At=window.screen.height,jt=window.screen.width,It=0,xt=window.devicePixelRatio,It="",V=0,kt=bt.length;kt>V;V++){
var Et=bt[V].getAttribute("data-src");
if(Et){
var zt=bt[V].getBoundingClientRect();
It+=jt+"|"+At+"|"+zt.left.toFixed(2)+"|"+(jt-zt.right).toFixed(2)+"|"+zt.width.toFixed(2)+"|"+xt.toFixed(2)+"|"+Et+";";
}
}
l({
...
e("appmsg/popup_report.js")),E=e("appmsg/pay_report_utils.js"),z=e("appmsg/loading.js"),P=-1,B=e("appmsg/finance_communicate.js"),S=e("appmsg/topbar.js"),C=e("biz_wap/utils/jsmonitor_report.js"),R=e("appmsg/getForbidConfig.js");
e("appmsg/wxwork_hidden.js");
var T=e("common/color/background_color.js"),O=e("common/color/dark.js");
T.set({
...
var q=window.user_uin||0,N=Math.floor(q/100)%1e3,D=0!==q&&1001>N,M=!0,L="",K=5;
