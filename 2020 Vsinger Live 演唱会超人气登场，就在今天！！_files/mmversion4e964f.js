...
if(""!==v.itemShowType&&null!==v.itemShowType&&void 0!==v.itemShowType&&_extends(i,{
itemShowType:v.itemShowType
}),""!==v.showSourceInfo&&_extends(i,{
showSourceInfo:v.showSourceInfo
}),"0"===v.itemShowType)_extends(i,{
...
var t=v.voiceid||0,o=v.duration||0;
_extends(i,{
...
function t(){
f&&m.invoke("currentMpInfoShow",{
userName:v.userName,
brandName:v.bizNickName
});
}
function o(){
f&&m.invoke("currentMpInfoHide");
}
function n(){
f&&(i(),w.getScrollTop()>v.showTitleHeight&&t());
}
function r(e){
var i=parseInt(Date.now()/1e3,10);
v.reportData.EnterId=v.reportData.EnterId&&10===v.reportData.EnterId.toString().length?v.reportData.EnterId:i;
var t=1*(w.getScrollTop()+w.getInnerHeight()),o=_extends(v.reportData,{
Event:e,
CurrScreen:3===e?Math.ceil(w.getScrollTop()/w.getInnerHeight()):0,
ExitHeight:3===e?Math.ceil(t):0
});
p.report(17335,o);
}
function a(){
m.on("topbar:click",function(){
r(3);
});
}
function s(){
var e=w.getScrollTop();
e>=v.showTitleHeight&&!b?(b=!0,f?(m.invoke("currentMpInfoShow",{
userName:v.userName,
brandName:v.bizNickName
}),N||(r(1),N=!0)):document.title=v.bizNickName):e<v.showTitleHeight&&b&&(b=!1,f?m.invoke("currentMpInfoHide"):document.title="");
}
function c(){
h.bindVisibilityChangeEvt(function(e){
!e&&w.getScrollTop()>=v.showTitleHeight&&(i(),t());
});
}
function d(){
var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];
e.bizNickName||(e.bizNickName=f?"未命名公众号":e.bizNickNameBackup);
for(var t in e)e[t]&&(v[t]=e[t]);
v.bizNickName=v.bizNickName.htmlDecode(),v.title=v.title.htmlDecode(),v.headImg=v.headImg.replace(/\/0$/,"/132"),
i(),a(),c(),h.on(window,"load",function(){
document.title="",s();
}),h.on(window,"scroll",I),window.addEventListener("pageshow",function(e){
e.persisted&&n();
});
}
var m=e("biz_wap/jsapi/core.js"),u=e("biz_wap/utils/mmversion.js"),p=e("common/comm_report.js"),l=e("pages/utils.js"),h=e("biz_common/dom/event.js"),w=e("common/utils.js"),g=e("biz_wap/utils/setMpInfo.js"),v={
showTitleHeight:40,
userName:"",
bizNickName:"",
bizNickNameBackup:"",
...
f="5"===v.itemShowType?u.isIOS&&u.gtVersion("7.0.12",!0)||u.isAndroid&&u.gtVersion("7.0.12",!0):u.isIOS&&u.gtVersion("7.0.10",!0)||u.isAndroid&&u.gtVersion("7.0.12",!0);
var I=l.throttle(s,50);
return{
setCurrentMpInfo:i,
showCurrentMpInfo:t,
hideCurrentMpInfo:o,
...
});define("common/utils.js",["biz_common/utils/url/parse.js","biz_wap/jsapi/core.js","biz_wap/utils/wapsdk.js","biz_wap/utils/storage.js","biz_wap/utils/device.js","biz_wap/utils/mmversion.js","biz_wap/jsapi/log.js"],function(e){
"use strict";
function t(){
return"1"===n.getQuery("isNativePage")||"2"===n.getQuery("isNativePage");
}
var n=e("biz_common/utils/url/parse.js"),i=e("biz_wap/jsapi/core.js"),o=e("biz_wap/utils/wapsdk.js"),a=e("biz_wap/utils/storage.js"),r=e("biz_wap/utils/device.js"),s=e("biz_wap/utils/mmversion.js"),c=e("biz_wap/jsapi/log.js");
try{
...
var p=[],l=[],u=new a("history4secondopen"),g="from",f=!1,h={
status:"loading"
},w=[],_={
isNativePage:t,
isNewNativePage:function(){
return"2"===n.getQuery("isNativePage");
},
...
__useWcSlPlayer:!1,
isWcSlPage:function(){
return _.__useWcSlPlayer;
},
getPlayerType:function(){
return _.isWcSlPage()?3:t()?2:1;
},
getParam:function(e){
if(!e)return null;
...
i.on("activity:state_change",function(e){
...
i.on("onMPPageAction",function(e){
...
window.__second_open__&&"string"==typeof e&&/^https?:\/\/mp.weixin.qq.com\//.test(e)&&u.set(g,location.href,Date.now()+1e4),
location.href=e.replace(/#.*$/,"")+"#wechat_redirect";
},
initNewPageHistoryStackFromSecOpen:function(){
var e=u.get(g);
if(e&&"string"==typeof e&&/^https?:\/\/mp.weixin.qq.com\//.test(e)&&(u.remove(g),
...
f||(f=!0,window.addEventListener("popstate",function(e){
e.state&&1===e.state.__mock_secopen_history_stack_reload__&&location.reload();
}));
},
initWebCompt:function(e,t){
((r.os.iphone||r.os.ipad)&&s.isWechat&&s.gtVersion("7.0.14",1)||r.os.android&&s.isWechat&&s.gtVersion("7.0.15",1))&&!function(){
var n=function(){
for(;w.length;){
var e=w.shift();
e(h);
...
console.log("wx config web compt result",e,i),c.info("wx config web compt result",e,i),
i&&i.err_msg&&-1===i.err_msg.indexOf(":ok")&&(h={
status:"error",
error:i.err_msg
...
var e=function(e){
-1!==e.err_msg.indexOf(":ok")?_.initNewPageHistoryStackFromSecOpen():(window.__failConfigWxOpen=!0,
c.info("failed to config wxopen: res not ok"));
};
if(s.isAndroid){
var t=s.getInner();
t>"27001037"&&"27001060">t||t>="27001100"?_.initWebCompt(["wxOpen","wxAd"],e):s.gtVersion("7.0.15",1)?(_.initWebCompt(["wxAd"]),
window.__failConfigWxOpen=!0,c.info("failed to config wxopen: android version check failed (gt 7.0.15)")):(window.__failConfigWxOpen=!0,
c.info("failed to config wxopen: android version check failed"));
}else s.gtVersion("7.0.15",1)?_.initWebCompt(["wxOpen","wxAd"],e):(window.__failConfigWxOpen=!0,
c.info("failed to config wxopen: ios version check failed"));
},
preloadWxOpenVideoForWcSlVideoSharePage:function(){
var e=document.getElementById("js_mpvedio");
if(e){
var t=e.offsetWidth,n=window.__nativeHeight__||e.offsetHeight,i=document.createElement("div");
i.innerHTML='<div class="js_mpvedio_preload" style="width:100%"><div class="js_page_video"><div class="js_inner"><div class="js_video_poster"><div class="video_mask"></div>'+('<wx-open-video width="'+t+'" height="'+n+'" fullscreen-after-orientation-change hide-ios-exit-btn-when-fullscreen></wx-open-video>')+'</div></div></div><div class="js_full_mask full_mask"></div></div>',
e.appendChild(i.firstElementChild),console.log("append preload wx-open-video"),c.info("append preload wx-open-video");
}
},
getWebComptStatus:function(e){
return"function"!=typeof e?h:("loading"===h.status?w.push(e):e(h),!0);
}
};
return _;
